...
class Os
{
    ...
    {
        $sql = 'SELECT OsID, OsDtInicial, OsDtFinal, OsGarantia, OsDescProdServ, OsDefeito, OsObs, OsCliID,tb_cliente.CliNome as nomeCliente, OsTecID, OsStatus, OsLaudoTec, OsValorTotal, OsFaturado, ProdOsID, ProdValorVenda, ProdOsQtd, ProdOsProdID, ProdDescricao, ProdOsSubTotal  
        FROM tb_os
        Inner Join tb_cliente on tb_cliente.CliID = tb_os.OsCliID
